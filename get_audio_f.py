...
df = pd.read_csv(f'{SAV_DIR}/{PROMPT_TYPE}_all_audio_features1.csv')
df1 = pd.DataFrame([], columns = feature_columns)
df1['name'] =  df['name'][START:END]
df1[feature_columns] = df1['name'].swifter.apply(lambda x: main(x))
